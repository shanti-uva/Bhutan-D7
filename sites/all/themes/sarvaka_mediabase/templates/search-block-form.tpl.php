...
?>
        ...
        <div class="search-group">
          <div class="input-group">
                    <?php print str_replace('<label class="element-invisible" for="edit-search-block-form--2">Search </label>', 
                    '<label class="flyout-search-label"><span>' . t('Search') . ':</span>' . t('Audio-Video') . '</label>', $search['search_block_form']); ?>
