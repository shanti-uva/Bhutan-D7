...
?>
<div id="<?php print $id; ?>" class="grid-desc">

    <h2><a href="<?php print $file_url; ?>"><?php print $label; ?></a></h2>
    <div class="links">
        <a href="#" class="btn btn-default btn-sm view-btn">View</a>
    </div>
    	<div class="file-desc-info">
		    <?php
		      hide($content['links']);
			  hide($content['file']);
			  print $ssfields;
