          ...
          <section class="content-section <?php if (!empty($bsclass_main)) { print " $bsclass_main"; } ?> ">
			...
			<div class="homepage-main-content">
			    ...
			    <div class="homepage-intro-text">
			        ...
			        <p class="bullet">Mandala Collections are scholarly repositories of <a href="https://texts.shanti.virginia.edu">Texts</a>, <a href="https://audio-video.shanti.virginia.edu">Audio-video</a>, <a href="https://images.shanti.virginia.edu">Images</a>, <a href="https://sources.shanti.virginia.edu">Bibliographies</a> (Sources), and <a href="https://visuals.shanti.virginia.edu">Visualizations</a> (Visuals), all of which are interconnected through their common use of Knowledge map nodes, which can be <a href="https://mandala.shanti.virginia.edu/places">Places</a>, <a href="https://mandala.shanti.virginia.edu/subjects">Subjects</a>, or <a href="https://mandala.shanti.virginia.edu/terms">Terms</a>.</p>
					    ...
					    <div class="wrap mobile">
					        ...
					        <div class="panel panel-default">
					          <div class="panel-heading">
					            <h3 class="panel-title">Getting Started</h3><!-- TO GET STARTED -->
					          </div>
					          <div class="panel-body">
					            <ul>
					                ...
					                <li>Next, catalog and connect content together by creating keyword relationships from the Knowledge Maps glossary of key-phrases from <a href="https://mandala.shanti.virginia.edu/subjects">Subjects</a>, <a href="https://mandala.shanti.virginia.edu/places">Places</a>, and <a href="https://mandala.shanti.virginia.edu/terms">Terms</a>.</li>
