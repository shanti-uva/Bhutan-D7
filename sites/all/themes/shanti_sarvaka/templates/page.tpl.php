<div class="wrap-all">
   <span class="sr-only"><a href=".main-content"><?php print('Skip to main content');?></a> <a href="#search-flyout"><?php print t('Skip to search');?></a></span>
    <!-- Header Region -->
   <div class="site-banner">
    <div class="navbar navbar-default">

	      <nav class="navbar-buttons">
	        <span class="menu-icon menu-toggle" role="button" aria-label="Main Menu"><a href="#"><span class="sr-only"><?php print ('Main Menu'); ?></span><span class="icon shanticon-menu"></span></a></span><!-- desktop > 768 drilldown menu : main-menu -->
	        <span class="menu-explore menu-exploretoggle" role="button" aria-label="Explore Collections"><a href="#"><span><?php print ('Explore'); ?></span><span class="icon shanticon-directions"></span></a></span><!-- mobile < 768 : collections -->
	      </nav>
        ...
        <h1 class="navbar-header<?php if(!$variables['shanti_site']) { print " default"; } ?>">
             ...
             <?php if($variables['shanti_site']): ?>
              <a href="<?php echo $mandala_home; ?>" class="logo-brand navbar-brand">
                ...
                <span class="mandala"><?php print t('Mandala'); ?> <em><?php print t('Collections'); ?></em></span>
