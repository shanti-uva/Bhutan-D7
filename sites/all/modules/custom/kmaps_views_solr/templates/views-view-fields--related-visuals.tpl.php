...
<div class="shanti-thumbnail-image shanti-field-visuals">
  <a href="/<?php print $view->args[0] . '/' . $view->args[1] ?>/visuals-node/<?php print $fields['visuals_id']->content ?>/nojs" class="shanti-thumbnail-link use-ajax">
    <span class="overlay">
  ...
  <div class="body-wrap">
    <div class="shanti-thumbnail-field shanti-field-title en">
      <span class="field-content">
        <a href="/<?php print $view->args[0] . '/' . $view->args[1] ?>/visuals-node/<?php print $fields['visuals_id']->content ?>/nojs"
          class="shanti-thumbnail-link use-ajax" 
          <?php 
            if (!empty($fields['visuals_title'])) { echo 'title="' . $fields['visuals_title']->content . '"';}
          ?>
        >
          <?php print $fields['visuals_title']->content; ?>
        </a>
      </span>
    </div>
    ...
    <?php if(!empty($fields['asset_subtype'])): ?>
      <div class="shanti-thumbnail-field shanti-field-type">
        <span class="shanti-field-content"><?php print $fields['asset_subtype']->content ?></span>
      </div>
    <?php endif; ?>
