<div id="<?php print $ajax ? $type . '-ajax' : $type . '-main' ?>">
    ...
    <section id="sidebar-first" class="region sidebar sidebar-first col-xs-6 col-md-3 sidebar-offcanvas ">
        <ul class="nav nav-pills nav-stacked">
            <li class="overview <?php print isset($overview) ? 'active' : ''; ?>"><a
                        href="<?php print base_path() . $type . '/' . $kid; ?>/overview/nojs" class="use-ajax">
          ...
          <?php if ($terms_count > 0 && $type !== 'terms'): ?>
              <li class="terms <?php print isset($terms) ? 'active' : '' ?>">
                  <a href="<?php print base_path() . $type . '/' . $kid; ?>/terms/nojs" class="use-ajax">
                      ...
                      Terms
                      <span class="badge"><?php print $terms_count; ?></span>
                  </a>
              </li>
          <?php endif; ?>
        </ul>
