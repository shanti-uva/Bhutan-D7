                ...
                if (jQuery(elem).popover) {
                    ...
                    jQuery(elem).popover({
                            ...
                            content: function () {
                                ...
                                resource = resource.charAt(0).toUpperCase() + resource.substr(1);
                                ...
                                popover = "<div id='popover-content-" + key + "'>" + "<div class='popover-body parents'><strong>" + resource + "</strong>" + path + "</div></div>";
                                return popover;
                            },
                            title: function () {
                                var title_match = title.match(/<strong>(.*?)<\/strong>/);
                                var current_title = "";
                                if(title_match != null){
                                    current_title = title_match[1];
                                }
